...
// --- AI-inferred biotope from species ---
...
// --- AI general knowledge habitats for Lucerne ---
...
function applyFilters() {
  ...
  allObservations.forEach(obs => {
    ...
    const threatened = obs.taxon?.threatened;
...
// --- Load city observations and generate overview ---
document.getElementById('loadCity').addEventListener('click', async () => {
  ...
  // Merge AI general biotopes with observed biotopes
  ...
  // Apply filters and show markers
  applyFilters();
});